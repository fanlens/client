...
class Job(object):
    ...
    def __init__(self, job=None, url=None):
        """
    ...
    def url(self):
        ...
        You can get info about the currently running job or cancel it under this url
