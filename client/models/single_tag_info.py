...
class SingleTagInfo(object):
    ...
    def __init__(self, tag=None, count=None):
        """
        SingleTagInfo - a model defined in Swagger
        """
    ...
    def tag(self):
        """
        Gets the tag of this SingleTagInfo.

        :return: The tag of this SingleTagInfo.
        :rtype: Tag
        """
        return self._tag
    ...
    def tag(self, tag):
        """
        Sets the tag of this SingleTagInfo.

        :param tag: The tag of this SingleTagInfo.
        :type: Tag
        """
        if tag is None:
    ...
    def count(self):
        """
        Gets the count of this SingleTagInfo.

        :return: The count of this SingleTagInfo.
        :rtype: int
        """
        return self._count
    ...
    def count(self, count):
        """
        Sets the count of this SingleTagInfo.

        :param count: The count of this SingleTagInfo.
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, SingleTagInfo):
            return False
